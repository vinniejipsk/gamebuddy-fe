...
import { Menu as MenuIcon, Person as PersonIcon, RateReview as RateReviewIcon, Search as SearchIcon } from '@mui/icons-material';
      ...
      <AppBar position="fixed">
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', marginRight: 4 }}>
            ...
            <Link to="/reviews/create" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', marginRight: 4 }}>
            ...
            <Link to="/users" style={{ textDecoration: 'none', color: 'inherit', marginRight: 2 }}>
              <Typography variant="h6" color="inherit" component="div">
                User
              </Typography>
            </Link>
